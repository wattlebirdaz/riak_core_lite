...
uniform_s(N, State) -> rand:uniform_s(N, State).
...
seed({_, _, _} = Seed) ->
    ...
    Old;
seed(Seed) ->
    Old = rand:export_seed(), _New = rand:seed(Seed), Old.

rand_bytes(Size) -> crypto:strong_rand_bytes(Size).

%%%===================================================================
%%% General functions
%%%===================================================================

rand_seed() -> erlang:timestamp().
