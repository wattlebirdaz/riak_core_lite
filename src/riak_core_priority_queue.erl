...
-export([new/0, is_queue/1, is_empty/1, len/1,
	 to_list/1, in/2, in/3, out/1, out/2, pout/1, join/2]).
...
merge_case() ->
    ...
    ?assertEqual([{0, 1}, {0, 3}, {0, 5}, {0, 2}, {0, 4},
		  {0, 6}],
    ...
    ?assertEqual([{60, 6}, {50, 5}, {40, 4}, {30, 3},
		  {20, 2}, {10, 1}],
